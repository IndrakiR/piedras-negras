...
<script setup>
useHead({
  title: 'Aviso de Privacidad - Municipio de Piedras Negras',
  meta: [
    {
      name: 'description',
      content: 'Aviso de Privacidad del H. Ayuntamiento de Piedras Negras. Información sobre el tratamiento de datos personales.'
    }
  ]
})
</script>
