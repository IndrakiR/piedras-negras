<template>
  ...
  >
    ...
    <input type="hidden" name="_subject" value="Registro Proveedor Persona Moral">
    <input type="hidden" name="_template" value="table">
    <input type="hidden" name="_captcha" value="false">

    <div class="mb-6">
      <a 
        href="/files/requisitos/PROVEEDOR-PERSONAS-MORALES-_Requisitos_.pdf"
        target="_blank"
    ...
    <div class="grid md:grid-cols-2 gap-6">
      ...
      <div class="space-y-4">
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">Giro Empresarial</label>
          <select 
